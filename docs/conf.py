...
try:
    ...
    raise SystemExit("winbond has to be importable")
...
linkcheck_ignore = [
    'https://forum.micropython.org/viewtopic.php?',
    # tag 0.4.0 did not exist during docs introduction
    'https://github.com/brainelectronics/micropython-winbond/tree/0.4.0',
    # RTD page did not exist during docs introduction
    'https://micropython-winbond.readthedocs.io/en/latest/',
]
